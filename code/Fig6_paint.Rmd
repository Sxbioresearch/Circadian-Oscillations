...
# 使用 UpSetR 创建 UpSet 图
upset(example_data, sets = c("A", "B", "C"))

# 设置隐藏集合 B
upset_options(hide_sets = c("B"))
upset(fromList(example_data), sets = c("A", "B", "C"))


upset(fromList(example_data), sets = c("A", set("B", hide = TRUE), "C"))
